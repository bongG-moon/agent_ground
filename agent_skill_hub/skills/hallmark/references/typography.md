...
- **Project-local fonts** already committed and licensed for the application.
- **Company-approved font library or package mirror**, copied into the project and self-hosted.
- **System font stack** when no approved local face exists.

Do not emit Google Fonts, Fontshare, or other remote font-service links. A public font may be imported only through the approved ingress and licence-review process, then served locally.

...
Use locally hosted, licence-approved Plus Jakarta Sans and JetBrains Mono files. If unavailable, use the nearest approved local or system alternatives. Never load a remote font stylesheet.

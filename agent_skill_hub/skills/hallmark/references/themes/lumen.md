...
Use locally hosted, licence-approved Instrument Serif, Geist, and JetBrains Mono files. If unavailable, use the nearest approved local or system alternatives. Never load a remote font stylesheet.

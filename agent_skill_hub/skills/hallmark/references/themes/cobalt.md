...
1. **Fonts** — prefer locally hosted, licence-approved **Space Grotesk** (display, 500/600), **Inter** (body, 400/500), and **JetBrains Mono** (code + small uppercase labels). If unavailable, use the nearest approved local or system alternatives. Never load a remote font stylesheet.

...
Keep collectors, exporters, storage, dashboards, and alert delivery on company-operated infrastructure. External observability SaaS, public telemetry endpoints, and vendor feedback upload are prohibited. Redact prompts, source code, credentials, personal data, production records, and sensitive paths before emitting telemetry.

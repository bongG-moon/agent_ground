...
4. Does the approved internal/offline vulnerability audit report known issues?
...
For triaging approved internal/offline audit findings and supply-chain risk (typosquatting, compromised maintainers), follow the `security-and-hardening` skill — this section covers the upgrade *workflow*, that one covers the security verdict.

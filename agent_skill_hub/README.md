...
- candidate 5개: `project-design-context`, `langflow-1-9-2-development`, `re0`, `mandela`, `ssotize`; blind eval 전이므로 기본 설치에서 제외
- routing eval suite 3개: 총 happy/negative case 51개

활성 31개와 candidate 5개의 ID·역할·호출 정책, 삭제된 14개 목록은 [SKILL_INVENTORY.md](./SKILL_INVENTORY.md)를 확인합니다.
...
├── SKILL_INVENTORY.md           # 활성 31개, candidate 5개, 삭제 14개 목록

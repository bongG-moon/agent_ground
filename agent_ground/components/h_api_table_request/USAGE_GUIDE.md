...
다른 Agent Ground 파일을 import하지 않으므로 Python 파일 하나만으로 등록할 수 있습니다. 실행 환경에는 `lfx`와 `requests`가 있어야 합니다. Langflow 1.9.2 / LFX 0.4.2 환경에서 template과 loader 계약을 확인했습니다.

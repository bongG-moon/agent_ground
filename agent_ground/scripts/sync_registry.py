...
def main() -> None:
    ...
    if len(flow_paths) != 8:
        raise ValueError(f"Registry에는 Flow manifest 8개가 필요합니다: {flow_paths}")
    ...
    payload = {
        ...
        "source_of_truth": "20 qualified Component manifests and 8 Flow manifests; internal nodes are excluded",

...
"""Build Langflow 1.9.2 import files for Business Agent Design.
...
sources, rebuilds every runtime template with LFX 0.4.2, and verifies the exact
handle encoding expected by Langflow 1.9.2.
"""
...
def main() -> None:
    ...
    flow = upgrade_flow(
        flow,
        module_prefix="agent_ground.business_agent_design",

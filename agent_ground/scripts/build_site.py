...
<section class="section">
  ...
  <div class="grid grid-3">
    ...
    <a class="card card-link" href="flows/drm_document_text_extraction_flow/index.html"><div class="meta-row">{badge('user_testing')}</div><h3>실습 G · 문서 텍스트 추출 (DRM 자동)</h3><p>PDF·PPT·Excel·Word 업로드를 로컬 우선·항상 DRM·DRM 미사용 모드로 처리하고, 필요한 파일만 허용된 DRM text API로 보내는 연결을 배웁니다.</p></a>
  </div>
</section>
<section class="section">

...
TARGET_VERIFIED_ENVIRONMENT = (
    "langflow-1.9.2-lfx-0.4.2-template-loader-and-isolated-contract-validation"
)
TARGET_LAST_VERIFIED_AT = "2026-07-26"
    ...
    if component_id in ENTERPRISE_UTILITY_IDS:
        ...
        if component_id == "drm_document_text_extractor":
            verified_environment = (
                "langflow-1.9.2-lfx-0.4.2-template-loader-fake-drm-and-vision-model-contract-validation"
            )
            last_verified_at = TARGET_LAST_VERIFIED_AT
        return {

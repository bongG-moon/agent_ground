...
data_request 중 datalake 요청만 골라 실행합니다.
...
| LAKE_USER_ID | `lake_user_id` | `MessageTextInput` | False | False | False |
| LAKE_JWT_TK | `lake_jwt_tk` | `MessageTextInput` | False | False | False |
...
`datalake_data.py` 파일 하나를 Agent Builder의 Custom Component로 등록합니다. 이 파일은 형제 모듈 import를 사용하지 않습니다.

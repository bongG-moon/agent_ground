...
기준 문서는 Langflow 공식 문서의 Custom Components, Components overview, Tool mode, Dynamic Create Data 설명이다. Langflow 버전에 따라 import path나 input class 이름이 조금씩 달라질 수 있다.
